    ...
    <div className="page">
      <div className="content">
        <div className="scrollable-content">
          <h>Lesson 2: Conway's Game of Life</h>
          <div>
            <p>Throughout this lesson, we will investigate unique patterns in Conway's game of life then let you play with the simulation</p>
            <p>&nbsp;</p>
          </div>
          ...
          <div>
            ...
            <p>If it's not already, expand the code editor with the slider to the left of the simulation</p>
            <p>For this lesson, we've been using Conway's rules. Lets change that. </p>
            <p>On line 62, change the right side of the equality statement from "&& neighbors &gt; 3" to "&& neighbors &gt; 4"</p>
